    """
    Config Diff E1dsf7hi
    ====================
    Developer-friendly CLI that helps you organise projects in seconds.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly CLI that helps you organise projects in seconds.")
